...
export const routes: Routes = [
    ...
    {path: '', component: AppPublicComponent,
        children: [
            ...
            {path: 'anuncio/novo/:id', component: ListingNewComponent, canActivate: [validParams, authGuard]},
            {path: 'anuncio/editar/:id', component: ListingEditComponent, canActivate: [validParams, authGuard]},
